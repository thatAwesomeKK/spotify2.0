...
export default function Sidebar() {
    ...
    return (
        <div className="text-gray-500 p-5 text-xs lg:test-sm border-r border-gray-900 overflow-y-scroll scrollbar-hide  h-screen sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex pb-36">
